    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            GLENROAST: The Neighborhood Café
          </motion.h1>
          <motion.p
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-stone-700 leading-relaxed mb-6">
              Glenroast is proud to be a part of the coffee movement by introducing specialty
              coffee rooted in craftsmanship from estates known for their high-end produce. Our
              aim is to offer a new experience that reshapes how coffee is enjoyed and appreciated
              in the region.
            </p>
            <Link href="/about">
              <motion.span
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="text-center lg:text-left">
              ...
              <motion.p
                className="text-stone-700 mb-6 text-xl"
                initial={{ opacity: 0, x: -30 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true, amount: 0.2 }}
                transition={{ duration: 0.7, ease: "easeOut", delay: 0.1 }}
              ...
              >
                <motion.a
                  href="#"
                  className="inline-block bg-[#F77E00] text-white font-medium py-3 px-6 rounded-md shadow hover:bg-[#d66c00] transition-colors duration-200 ease-in-out cursor-pointer text-sm"
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 400, damping: 15 }}
                  target="_blank"
                ...
                <motion.a
                  href="#"
                  className="inline-block bg-[#EF4F5F] text-white font-medium py-3 px-6 rounded-md shadow hover:bg-[#d94251] transition-colors duration-200 ease-in-out cursor-pointer text-sm"
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 400, damping: 15 }}
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
              ...
              >
                ...
                <h3 className="text-xl lg:text-2xl font-semibold font-display text-stone-800 mb-2">Blueberry Cheesecake</h3>
                <p className="text-stone-600 text-sm leading-relaxed">Baked cheesecake topped with blueberries.</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="relative h-64 rounded-lg overflow-hidden mb-4 bg-stone-200"></div>
                <h3 className="text-xl lg:text-2xl font-semibold font-display text-stone-800 mb-2">Fish & Chips</h3>
                <p className="text-stone-600 text-sm leading-relaxed">Traditional Irish fish & chips, with tartar sauce and salted chips</p>
              </motion.div>
            </div>
          </div>
          <motion.div
      ...
      <section ref={ambianceRef} className="relative h-[60vh] md:h-[75vh] overflow-hidden flex items-center justify-center">
        ...
        >
          <p className="text-4xl md:text-5xl font-display font-medium text-white text-shadow-lg leading-tight">
            &ldquo;Bridging Social Capital – A space for meaningful dialogue&rdquo;
          </p>
        </motion.div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-16 lg:space-y-20">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-stone-700 leading-relaxed text-sm">
                More than just a café, it&apos;s a cozy retreat where you can feel right at
                home. Enjoy the welcoming atmosphere, whether you’re here to work or relax.
              </p>
            </div>
            <motion.div
          ...
          >
            <div className="space-y-6 md:order-last">
              ...
              <p className="text-stone-700 leading-relaxed text-sm">
                We&apos;re passionate about bringing specialty coffee to Jorhat. Discover our
                curated selections, expertly crafted to highlight unique flavors that might become
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-stone-700">
                    GLENROAST <br />
                    Clubroad, Near Hotel Clubway Grand <br />
                    Jorhat, Assam
                  </p>
                </div>
                <div className="flex items-start gap-3">
